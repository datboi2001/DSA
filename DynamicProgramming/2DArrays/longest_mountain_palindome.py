def mountain_palindrome(s: str) -> str:
    """
    :param s: string
    :return: longest mountain palindrome such that s0 < s1 > s2 < s3 > ... < sn-1
    """ 
    # Main idea: Dynamic Programming. The main idea is to maintain a table
    #  dp[i][j] which is true if s[i:j] is a mountain palindrome, otherwise false.
...
print(mountain_palindrome("aabeebaa"))
